...
public class GamePad {
	...
	public static final int A = 1;//Bottom Button	Push intake
	public static final int B = 2;//Right Button	Shift
	public static final int X = 3;//Left button		Top Push Block
	public static final int Y = 4;//Top Button		Climber?
